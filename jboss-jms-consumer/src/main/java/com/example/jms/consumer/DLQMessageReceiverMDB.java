...
@MessageDriven(name = "DLQMessageReceiverMDB", activationConfig = {
...
public class DLQMessageReceiverMDB implements MessageListener {

    private static final java.util.logging.Logger LOGGER = java.util.logging.Logger.getLogger(DLQMessageReceiverMDB.class.getName());
